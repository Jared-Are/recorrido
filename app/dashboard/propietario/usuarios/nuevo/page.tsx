...
export default function NuevoUsuarioPage() {
  ...
  const [formData, setFormData] = useState({
    nombre: "",
    email: "",
    rol: "tutor" as "propietario" | "asistente" | "tutor",
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: "Usuario registrado", description: "El usuario ha sido registrado exitosamente." })
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="email">Email (Será su usuario) *</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.rol}
                  onValueChange={(value: "propietario" | "asistente" | "tutor") => setFormData({ ...formData, rol: value })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
